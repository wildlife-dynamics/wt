...
- `docs/solutions/` - Documented solutions to problems encountered during development
- `docs/guides/` - Best practices guides and patterns

**Note for `/workflows:compound`**: All documentation generated by the compound workflow must be placed in `docs/` (not the repo root). Use `docs/solutions/<category>/` for problem solutions and `docs/guides/<topic>/` for general guides. Update this section if adding new documentation categories.
