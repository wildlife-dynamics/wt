...
class TestRegistryEntry:
    ...
    def test_minimal_entry(self) -> None:
        ...
        assert entry.module_path == "mypackage.tasks._internal"
    ...
    def test_entry_with_complex_schema(self) -> None:
        ...
        entry = RegistryEntry(
            ...
            module_path="math_utils._internal",
            public_module_path="math_utils",
            function_name="add",
            import_statement="from math_utils import add as add",
            json_schema=schema,
        )
    ...
    def test_entry_serialization_roundtrip(self) -> None:
        ...
        entry = RegistryEntry(
            ...
            module_path="data.processors._internal",
            public_module_path="data.processors",
            function_name="process",
            import_statement="from data.processors import process as process",
            json_schema={
                "type": "object",
        ...
        assert entry2.public_module_path == entry.public_module_path
...
class TestRegistryOutput:
    ...
    def test_registry_with_entries(self) -> None:
        ...
        entry1 = RegistryEntry(
            ...
            function_name="func1",
            import_statement="from pkg.tasks import func1 as func1",
            json_schema={},
        )
        ...
        entry2 = RegistryEntry(
            ...
            public_module_path="pkg.tasks",
            function_name="func2",
            import_statement="from pkg.tasks import func2 as func2",
            json_schema={},
        )
    ...
    def test_registry_output_complete_roundtrip(self) -> None:
        ...
        cli_data = {
            ...
            "entries": {
                "mylib.calculate_mean": {
                    ...
                    "module_path": "mylib.stats._internal",
                    "public_module_path": "mylib.stats",
                    "function_name": "calculate_mean",
                    "import_statement": "from mylib.stats import calculate_mean as calculate_mean",
                    "json_schema": {
                        "type": "object",
                        "properties": {
                            "values": {
        ...
        assert entry.module_path == "mylib.stats._internal"
        assert entry.public_module_path == "mylib.stats"
    ...
    def test_registry_output_validation(self) -> None:
        ...
        valid_data = {
            "entries": {
                "pkg.func": {
                    ...
                    "module_path": "pkg._internal",
                    "public_module_path": "pkg",
                    "function_name": "func",
                    "import_statement": "from pkg import func as func",
                    "json_schema": {},
                }
            }
        }
        ...
        # Invalid entry (missing required field - public_module_path)
        invalid_data = {
            "entries": {
                "pkg.func": {
                    "metadata": {"title": "Test", "description": "Test func"},
                    "module_path": "pkg",
                    # Missing public_module_path
                    "function_name": "func",
