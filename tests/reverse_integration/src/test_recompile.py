...
class TestRecompile:
    ...
    def test_no_unexpected_diff(
        ...
        if show_diff_analysis and diff_result.variance_results:
            ...
            analysis = format_variance_analysis(diff_result.variance_results, conditional_entries)
            print(f"\n{analysis}")
    ...
    def test_required_artifacts_exist(
        ...
        missing = [
            file_name for file_name in required_files if not (generated_path / file_name).exists()
        ]
